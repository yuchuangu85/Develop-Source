<h1 align="center">写给 Android 应用工程师的 Binder 原理剖析</h1>
...
我们知道 Android 应用程序是由 Activity、Service、BroadcastReceiver 和 ContentProvider 四大组件中的一个或者多个组成的。有时这些组件运行在同一进程，有时运行在不同的进程。这些进程间的通信就依赖于 Binder IPC 机制。不仅如此，Android 系统对应用层提供的各种服务如：ActivityManagerService、PackageManagerService 等都是基于 Binder IPC 机制来实现的。Binder 机制在 Android 中的位置非常重要，毫不夸张的说理解 Binder 是迈向 Android 高级工程的第一步。
...
![Linux 背景知识](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)Linux 背景知识
...
![传统 IPC 通信原理](media/640-20201203140006821.png)传统 IPC 通信原理
...
![Binder IPC 原理](media/640-20201203140006752.png)										 
...
![img](media/640-20201203140006769.png)
...
![互联网通信模型](media/640-20201203140006749.png)										互联网通信模型
...
![Binder 通信模型](media/640-20201203140006793.png)
...
![img](media/640-20201203140006729.png)
...
![img](media/640-20201203140006777.png)
