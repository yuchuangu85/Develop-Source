<h1 align="center">Java 中 volatile 关键字的最全总结</h1>
...
在多线程环境下，一个线程对共享变量的操作对其他线程是不可见的。Java提供了volatile来保证可见性，当一个变量被volatile修饰后，表示线程本地内存无效，当一个线程修改共享变量后他会立即被更新到主内存中，其他线程读取共享变量时，会直接从主内存中读取。
...
<img src="media/Screen%20Shot%202020-06-27%20at%2020.36.50.png" alt="Screen Shot 2020-06-27 at 20.36.50" style="zoom:50%;" />
