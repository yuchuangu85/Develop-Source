...
1. [前言](http://www.hawstein.com/posts/google-java-style.html#Intro)
2. [源文件基础](http://www.hawstein.com/posts/google-java-style.html#SFBasic)
3. [源文件结构](http://www.hawstein.com/posts/google-java-style.html#SFStruct)
4. [格式](http://www.hawstein.com/posts/google-java-style.html#Format)
5. [命名约定](http://www.hawstein.com/posts/google-java-style.html#Naming)
6. [编程实践](http://www.hawstein.com/posts/google-java-style.html#Practice)
7. [Javadoc](http://www.hawstein.com/posts/google-java-style.html#Javadoc)
8. [后记](http://www.hawstein.com/posts/google-java-style.html#End)
...
String unitAbbrev = "μs";                                 | 赞，即使没有注释也非常清晰 String unitAbbrev = "\u03bcs"; // "μs"                    | 允许，但没有理由要这样做 String unitAbbrev = "\u03bcs"; // Greek letter mu, "s"    | 允许，但这样做显得笨拙还容易出错 String unitAbbrev = "\u03bcs";                            | 很糟，读者根本看不出这是什么 return '\ufeff' + content; // byte order mark             | Good，对于非打印字符，使用转义，并在必要时写上注释
...
2. 类内的第一个成员前或最后一个成员后的空行是可选的(既不鼓励也不反对这样做，视个人喜好而定)。
3. 要满足本文档中其他节的空行要求(比如3.3节：import语句)
...
3. 类型和变量之间：List list。
4. 数组初始化中，大括号内的空格是可选的，即new int[] {5, 6}和new int[] { 5, 6 }都是可以的。
