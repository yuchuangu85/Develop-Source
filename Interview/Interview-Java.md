<h1 align="center">Interview Java</h1>
...
抽象类的意义，接口的意义，抽象类和接口区别和应用场景

## 第十一章 内部类

### 什么是内部类？内部类的作用

父类的静态方法能否被子类重写？静态属性和静态方法是否可以被继承？是否可以被重写，以及原因？静态内部类的设计意图？成员内部类、静态内部类、局部内部类和匿名内部类的理解，以及项目中的应用？
...
HashMap、SpareArray、ConcurrentHashMap实现原理
...
### String、StringBuffer、StringBuilder区别：参看：Java-->String.md
